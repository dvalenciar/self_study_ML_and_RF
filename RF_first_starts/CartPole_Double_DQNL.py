...
Date: 28 - April - 2020
Deep-Q learning version version 2.1,
Algorith called double DQN. 2DQN
The key point of Double DQN is --> selections of action is from model
...
class DQNAgent:
    ...
    def train_model_2(self):
        ...
        target_act = self.model.predict(next_state_update)
    ...
    def save_model(self):
        self.model.save('CartPole_model_double_DQN.h5')
...
if __name__ == "__main__":
    ...
    plt.ylabel('Score')
    plt.xlabel('Episode')
    plt.title(' CartPole Environment Deep-Q-Learning(double DQN)')
    plt.show()